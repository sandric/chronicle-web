(!Object.create||!Object.defineProperty||!Object.defineProperties)&&alert("This browser is not supported!");var __filename=""+window.location;window.Streamline={globals:{}};function require(h){if("streamline/lib/globals"==h)return Streamline.globals;if("streamline/lib/callbacks/runtime"==h)return Streamline.runtime;alert("cannot require "+h)}
(function(h){function s(g,b,c,e,i,f,d){b.offset=c;b.col=e;var j=a.context;return function k(m,h){d&&(h=Array.prototype.slice.call(arguments,1));d=!1;var l=a.frame;a.frame=b;a.context=j;0===a.depth&&a.emitter&&a.emitter.emit("resume");a.depth++;try{if(f&&b.active&&a.trampoline)a.trampoline.queue(function(){return k(m,h)});else{if(k.dispatched&&(c||e))throw Error("callback called twice");k.dispatched=!0;if(m)return n(m,b),g(m);b.active=!0;return i(null,h)}}catch(p){if(k.dispatched&&"___"!==g.name&&
    ...
    a.__lookupGetter__("stack");if(!c)var e=a.stack||"raw stack unavailable",c=function(){return e};a.__defineGetter__("rawStack",c);a.__defineGetter__("stack",function(){var b=c();"object"===typeof navigator&&-1<navigator.userAgent.toLowerCase().indexOf("firefox")&&(b="Error: "+a.message+"\n"+b);var f=b,d,e;if(f){f=f.split("\n");f=f[0]+"\n    <<< async stack >>>\n"+f.slice(1).map(function(a){var b="object"===typeof navigator&&"function"===typeof require&&require.async?11:0,c=/([^@]*)\@(.*)\:(\d+)$/.exec(a),
    a=c?"    at "+c[1]+" ("+c[2]+":"+(parseInt(c[3])-b)+":0)":a,b=a.indexOf("__$");return 0<=b&&!e?(e=!0,a.substring(0,b)+a.substring(b+3)):e?"":a}).filter(function(a){return a}).join("\n");for(d=a.__frame;d;d=d.prev)0<=d.offset&&(f+="\n    at "+d.name+" ("+d.file+":"+(d.line+d.offset)+":"+d.col+")")}d=b.indexOf("\n");return f+="\n    <<< raw stack >>>"+(0<=d?b.substring(d):b)})}}var a=require("streamline/lib/globals");a.runtime="callbacks";a.context=a.context||{};a.depth=a.depth||0;var r=[];a.trampoline=
